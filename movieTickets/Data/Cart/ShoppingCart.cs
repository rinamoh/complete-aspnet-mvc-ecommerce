...
{
    //going to be used to add and remove data from the shopping cart
    public class ShoppingCart
    {
        ...
        //the method to return everything in the shopping cart
        ...
        //method to get the total price of the shopping cart ;)
